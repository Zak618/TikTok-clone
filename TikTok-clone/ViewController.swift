...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private var videoLinks: [String] = ["https://www.tiktok.com/@unclemrakula/video/7053207989615971586?q=berserk&t=1687713852939",
    ...
    override func viewDidLoad() {
        ...
        tableView.snp.makeConstraints {
            maker in maker.edges.equalToSuperview()
        }
        ...
        blackView.snp.makeConstraints {
            maker in maker.left.right.bottom.equalToSuperview()
        ...
        stackView.snp.makeConstraints {
            maker in maker.left.right.bottom.equalToSuperview().inset(15)
